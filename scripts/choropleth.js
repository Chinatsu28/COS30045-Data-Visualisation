            ...
            const features = svg
                ...
                .on("mouseover", function (d) {
                    ...
                    svg
                        ...
                        .attr("x", tooltipX + tooltipWidth / 2 + 15)
                ...
                .on("click", function (d) {
                    ...
                    if (captionElement) {
                        captionElement.innerHTML = `Population Change in ${selectedPrefecture} by <span class="font-weight-bold">number of </span>people in each age group`;
                    } else {
